...
class Rossmann(object):
    ...
    def data_cleanning(self, df1):
        ...
        df1['open'] = df1.apply(lambda x: 0 if math.isnan(x['open']) else x['open'], axis=1) 
    ...
    def feature_engineering(self, df2):
        ...
        cols_drop = ['promo_interval', 'month_map']
    ...
    def data_preparation(self, df5):
        ...
        cols_selected = ['store', 'promo', 'store_type', 'assortment', 'competition_distance', 'competition_open_since_month', 'competition_open_since_year', 'promo2', 'promo2_since_week',
                         'promo2_since_year', 'competition_time_month', 'promo2_time_week', 'month_sin','month_cos', 'day_sin', 'day_cos', 'week_of_year_sin', 'week_of_year_cos', 'day_of_week_sin', 'day_of_week_cos']
...
###################################################### KAGGLE ######################################################
    ...
    def data_cleanning_kaggle(self, df1):
    ...
    def feature_engineering_kaggle(self, df2):
    ...
    def data_preparation_kaggle(self, df5):
    ...
    def get_prediction_kaggle(self, model, original_data, test_data):
        # prediction
        pred = model.predict(test_data)
